...
import com.iamnana.movieApi.auth.entities.UserRole;
...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest loginRequest){
        ...
        var user = userRepository.findByEmail(loginRequest.getEmail()).orElseThrow(()-> new UsernameNotFoundException("The user doesn't exist!"));
